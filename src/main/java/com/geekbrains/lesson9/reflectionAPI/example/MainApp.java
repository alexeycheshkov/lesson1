...
/*        List<Method> executionList = Arrays.stream(TestClass.class.getDeclaredMethods())
        ...
        for (Method method : executionList) {
            method.invoke(null);
        }*/
    }
    ...
    private static void updateEx() throws SQLException {
        statement.executeUpdate("UPDATE students SET score = 80 WHERE id = 3;");
    }
    ...
    private static void insertEx() throws SQLException {
        statement.executeUpdate("INSERT INTO students (name, score) VALUES ('Den', 30);");
    }

    public static void connect() throws SQLException {
        try {
            Class.forName("org.sqlite.JDBC");
            connection = DriverManager.getConnection("jdbc:sqlite:src/main/java/com/geekbrains/lesson9/SQL/database_lesson9.db");
